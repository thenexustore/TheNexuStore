...
export function MobileFilters({
  ...
  // Two-phase open: mount → next frame triggers CSS transition
  const open = () => {
    setVisible(true);
    ...
    <>
      ...
      {visible && (
        ...
        >
          ...
          {/* Slide-in panel */}
          <div
            className={`fixed inset-y-0 right-0 flex w-full max-w-sm flex-col bg-white shadow-2xl transition-transform duration-300 ease-in-out ${
