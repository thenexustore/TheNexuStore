...
export const DEFAULT_HOMEPAGE_SECTIONS: Array<{
  ...
  },
  {
    ...
    position: 2,
    config_json: { source: 'query', query: { type: 'categories', limit: 10 } },
  },
  {
    type: HomepageSectionType.BEST_DEALS,
    title: 'Best Deals',
    position: 3,
    config_json: { source: 'query', query: { type: 'products', sortBy: 'discount_desc', inStockOnly: true, limit: 12 } },
  },
  {
    type: HomepageSectionType.NEW_ARRIVALS,
    title: 'New Arrivals',
    position: 4,
    config_json: { source: 'query', query: { type: 'products', sortBy: 'newest', inStockOnly: true, limit: 12 } },
  },
  {
    type: HomepageSectionType.FEATURED_PICKS,
    title: 'Featured Picks',
    position: 5,
    config_json: { source: 'query', query: { type: 'products', inStockOnly: true, limit: 12 } },
  },
  {
