...
describe('Infortisa category mapping', () => {
  ...
  it('maps Cámara IP into Gaming y smart home', () => {
    expect(recommendParentCategory(null, 'Cámara IP').label).toBe(
      'Gaming y smart home',
    );
  });

  it('maps Cámara inalámbrica into Gaming y smart home', () => {
    expect(recommendParentCategory(null, 'Cámara inalámbrica').label).toBe(
      'Gaming y smart home',
    );
  });

  it('maps Cámara WiFi into Gaming y smart home', () => {
    expect(recommendParentCategory(null, 'Cámara WiFi').label).toBe(
      'Gaming y smart home',
    );
  });

  it('maps NVR into Gaming y smart home', () => {
    expect(recommendParentCategory(null, 'NVR 8 canales').label).toBe(
      'Gaming y smart home',
    );
  });

  it('maps DVR into Gaming y smart home', () => {
    expect(recommendParentCategory(null, 'DVR videovigilancia').label).toBe(
      'Gaming y smart home',
    );
  });

  it('maps Videoportero into Gaming y smart home', () => {
    expect(recommendParentCategory(null, 'Videoportero WiFi').label).toBe(
      'Gaming y smart home',
    );
  });
