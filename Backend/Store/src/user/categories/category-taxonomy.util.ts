...
> = {
  'ordenadores-portatiles': [
    ...
    },
    {
      ...
      sortOrder: 30,
      keywords: ['mini pc', 'nettop', 'thin client', 'cliente ligero', 'barebone'],
    },
  ],
  'componentes-almacenamiento': [
    {
      ...
      sortOrder: 10,
      keywords: ['placa', 'motherboard', 'grafica', 'gpu', 'procesador', 'cpu', 'chasis'],
    },
    {
      key: 'memoria-almacenamiento',
      label: 'Memoria y almacenamiento',
      sortOrder: 20,
      keywords: ['ssd', 'hdd', 'nvme', 'disco', 'memoria', 'ram', 'almacenamiento'],
    },
    {
      key: 'energia-refrigeracion',
      label: 'Energía y refrigeración',
      sortOrder: 30,
      keywords: ['fuente', 'psu', 'ventilador', 'cooler', 'disipador', 'refrigeracion'],
    },
    {
  ...
  'monitores-perifericos': [
    ...
    },
    {
      ...
      sortOrder: 30,
      keywords: ['auricular', 'headset', 'altavoz', 'microfono', 'webcam', 'capturadora'],
    },
    {
      key: 'docks-lectores-accesorios',
      label: 'Docks, lectores y accesorios',
      sortOrder: 40,
      keywords: ['dock', 'hub', 'lector', 'stylus', 'pen tablet', 'grabadora'],
    },
  ],
  'impresion-escaneado': [
    {
  ...
  'redes-servidores': [
    {
      ...
      label: 'Redes y Wi‑Fi',
      sortOrder: 10,
      keywords: ['switch', 'router', 'wifi', 'mesh', 'repetidor', 'access point', 'punto de acceso'],
    },
    {
  ...
  'telefonia-movilidad': [
    {
      ...
      sortOrder: 10,
      keywords: ['smartphone', 'telefono', 'mifi', 'pda'],
    },
    {
      key: 'tablets-wearables',
      label: 'Tablets y wearables',
      sortOrder: 20,
      keywords: ['tablet', 'smartwatch', 'wearable', 'gps'],
    },
    {
      key: 'accesorios-movilidad',
      label: 'Accesorios de movilidad',
      sortOrder: 30,
      keywords: ['funda', 'cargador movil', 'protector pantalla', 'accesorio movil'],
    },
  ],
  'tv-audio-video': [
    {
      ...
      sortOrder: 10,
      keywords: ['television', 'televisión', 'tv', 'oled', 'qled', 'google tv', 'android tv'],
    },
    {
    ...
    },
    {
      ...
      sortOrder: 30,
      keywords: ['proyector', 'streaming', 'tdt', 'soporte tv', 'pantalla proyeccion'],
    },
  ],
  'software-seguridad': [
    {
    ...
    },
    {
      ...
      sortOrder: 20,
      keywords: ['antivirus', 'backup', 'endpoint', 'vpn', 'certificado', 'firma electronica'],
    },
    {
      key: 'sistemas-operativos-virtualizacion',
      label: 'Sistemas operativos y virtualización',
      sortOrder: 30,
      keywords: ['windows', 'linux', 'sistema operativo', 'virtualizacion', 'virtualización'],
    },
  ],
  'gaming-smart-home': [
    {
      ...
      label: 'Gaming',
      sortOrder: 10,
      keywords: ['gaming', 'consola', 'vr', 'simracing', 'gamepad', 'mando', 'volante'],
    },
    {
      key: 'smart-home-domotica',
      label: 'Smart home y domótica',
      sortOrder: 20,
      keywords: ['smart home', 'domotica', 'domótica', 'sensor', 'iluminacion', 'cerradura inteligente'],
    },
    {
  ...
  'accesorios-consumibles': [
    ...
    {
      key: 'fundas-soportes-transporte',
      label: 'Fundas, soportes y transporte',
      sortOrder: 30,
      keywords: ['bolsa', 'mochila', 'maletin', 'funda', 'soporte', 'brazo monitor'],
    },
    {
      key: 'pilas-baterias',
...
export function normalizeCategoryTaxonomyRows(
  ...
  return [...syntheticParents, ...syntheticLevel2Parents.values(), ...clonedRows.filter((row) => !aliasRowIds.has(row.id))];
}
