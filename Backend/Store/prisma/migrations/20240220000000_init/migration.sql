...
-- CreateIndex
CREATE UNIQUE INDEX "SyncLog_type_key" ON "SyncLog"("type");
...
-- CreateIndex
CREATE UNIQUE INDEX "FeaturedProduct_product_id_key" ON "FeaturedProduct"("product_id");

-- CreateIndex
CREATE INDEX "FeaturedProduct_sort_order_idx" ON "FeaturedProduct"("sort_order");

-- CreateIndex
CREATE INDEX "FeaturedProduct_is_active_idx" ON "FeaturedProduct"("is_active");

-- CreateIndex
CREATE INDEX "FeaturedProduct_created_at_idx" ON "FeaturedProduct"("created_at" DESC);
...
-- AddForeignKey
ALTER TABLE "FeaturedProduct" ADD CONSTRAINT "FeaturedProduct_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "Product"("id") ON DELETE CASCADE ON UPDATE CASCADE;
