          ...
          <div className="md:justify-self-end w-full md:max-w-sm">
            ...
            <div className="space-y-3 text-sm text-white/70">
              ...
              >
                <LocationOnIcon
                  sx={{ fontSize: 16 }}
                  className="mt-0.5 shrink-0 group-hover:text-white transition"
                />
                <span className="group-hover:text-white transition">
                  Paseo de las Palmeras, 3, Local B, 51001 Ceuta
                </span>
              </div>
              ...
              >
                <MailIcon
                  sx={{ fontSize: 16 }}
                  className="shrink-0 group-hover:text-white transition"
                />
                <span className="group-hover:text-white transition">
                  administracion@nexusssolutions.com
                </span>
              </div>
